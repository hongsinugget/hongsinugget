![홍시너겟_큰배너](https://github.com/user-attachments/assets/e2d06e0f-59f4-47da-a095-b60394bc7a15)

## 🌊 작은 손길로 시작된 무언가가 세상에 울림을 만들 수 있기를.
> 하는 일이 비록 작아 보일지라도, 결국엔 의미 있는 결과를 만들어낼 수 있다는 의미입니다.

## 👋 About Me

디자인으로 감각을, 마케팅으로 데이터를, 그리고 개발의 **실현 능력**을 결합하여 대체 불가능한 사람이 되고 싶습니다.  
단순한 개발을 넘어, 사회적 문제를 해결하는 **시빅 해킹**과 **선한 영향력**에도 깊은 관심을 두고 있습니다.
